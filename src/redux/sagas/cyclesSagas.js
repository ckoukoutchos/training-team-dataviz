...
import { fetchAllCyclesMetricsSuccess, fetchAllCyclesMetricsFail } from '../actions';
import { sortMetircsByAssociate, formatAssociateData, getCycleMetrics, formatCycleData, getAssociateAggregations, getCycleAggregations, getAllCyclesAggregations } from '../../shared/dataService';
...
function* fetchAllCyclesMetrics() {
  try {
    ...
    const { allCycleAggregations, cycleAggregations, formattedCycles } = formatAllCycleData(data, cycles);
    yield put(fetchAllCyclesMetricsSuccess(allCycleAggregations, cycleAggregations, formattedCycles));
  } catch (err) {
