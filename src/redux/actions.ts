import { FETCH_ALL_CYCLES_METRICS, FETCH_ALL_CYCLES_METRICS_SUCCESS, FETCH_ALL_CYCLES_METRICS_FAIL, POST_CYCLE_METRICS, POST_CYCLE_METRICS_SUCCESS, POST_CYCLE_METRICS_FAIL, RESET_ERROR, ActionTypes } from './actionTypes';
...
export const fetchAllCyclesMetricsSuccess = (allCycleAggregations: any, cycleAggregations: CycleAggregation[], formattedCycles: Cycle[]): ActionTypes => ({
...
export const postCycleMetrics = (formData: FormData, cycleName: string, history: History): ActionTypes => ({
